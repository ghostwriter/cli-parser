...
[![Automation](https://github.com/ghostwriter/cli-parser/actions/workflows/automation.yml/badge.svg)](https://github.com/ghostwriter/cli-parser/actions/workflows/automation.yml)
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/cli-parser?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/cli-parser?color=F28D1A)](https://packagist.org/packages/ghostwriter/cli-parser)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/cli-parser&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/cli-parser
```
...
- [All Contributors](https://github.com/ghostwriter/cli-parser/contributors)
